...
# Feature extraction function tailored for spectral contrast
...
def prepare_data(data_dir, feature_type="spectral_contrast"):
    features = []
    labels = []
...
visualize_gmm_clusters(data_dir, feature_type="spectral_contrast", num_components=4, zoom_multiplier=2)
